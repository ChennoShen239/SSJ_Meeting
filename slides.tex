...
The paper's claim is that, at \alert{second order},
\[
...
This is the paper's second-order analogue of the usual SSJ logic.

\end{frame}

\begin{frame}{2nd SSJ}{3. Why does this matter?}
\footnotesize
...
So this is not a different solution concept.  
It is best seen as a \alert{continuous-time version of FNA} with a cleaner first step.
\end{alertblock}
